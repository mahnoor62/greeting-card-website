    ...
    <>
      ...
      >
        <Container
          ...
          sx={{pt:5, pb:5 , display:'flex', justifyContent:'center', alignItems:'center', flexDirection:'column', height:'100%'}}>
          <Typography
            gutterBottom
            variant="h3"
            padding="10px"
          ...
          >
            {(isSmallScreen
              ...
              <SwiperSlide key={index} >
                <Grid container spacing={3} sx={{ display:'flex', justifyContent:'center', alignItems:'center', flexDirection:'row', height:'100%',   my:10}}>
                  {group.map((client, i) => (
                    <Grid item xs={12} md={6} lg={6} key={i}>
                      <Card sx={{ p: 3 }}>
                        ...
                        <Typography sx={{ textAlign: 'justify', mt: 3,mb:3, fontWeight:900 }}>
                          {client.review}
                        </Typography>
                      </Card>
                    </Grid>
